...
## 7. Graduation popup + direct handover

1. Sign in with a user whose grad date is current/past month.
2. On landing, show the "Have you graduated?" popup.
3. Click "Yes, I've graduated" and complete the handover form (UIN + personal email).
4. Confirm account is converted to FORMER_STUDENT and landing/profile reflects updated role.
...
- Graduation popup and direct handover
