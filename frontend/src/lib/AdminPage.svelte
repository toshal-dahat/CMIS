<script lang="ts">
  ...
  async function waitForCacheAndReload(step: string) {
    cacheMsg = step;
    // Backend flushes API Gateway cache on write; 2s is enough for propagation
...
{#if showThemeNotice}
  <div class="notice-overlay" role="dialog" aria-modal="true">
    <div class="notice-dialog">
      ...
      <p class="notice-body">
        Please click on the refresh button on the navigation bar to apply the latest theme when you see it in sometime.
      </p>
