<script lang="ts">
  ...
  function handleTeamTrigger(panel: CompetitionPanel, team: Team) {
    ...
    panel.triggerStatus = `UI trigger is ready for ${team.teamName}. Backend team feedback synthesis endpoint still needs to be connected.`;
  }
                          ...
                          <tr>
                            ...
                            <td>
                              <button
                                class="btn-table"
                                type="button"
                                disabled={!teamReady(panel, team.teamId)}
