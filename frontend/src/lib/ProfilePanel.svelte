<script lang="ts">
  ...
  import {
    ...
    emptyEducationEntry,
    gpaFromMostRecentEducation,
    mergeLegacyProfileGpaIntoEducation,
  ...
  function syncFormFromProfile() {
    ...
    educationEntries = mergeLegacyProfileGpaIntoEducation(
      cloneEducationEntries(p.profileEducation),
      p.profileGpa
    );
    const derivedProfileGpa = gpaFromMostRecentEducation(educationEntries);
    profileGpaStr =
      derivedProfileGpa != null
        ? String(derivedProfileGpa)
    ...
    if (isStudentRole) {
      ...
      if (profileGpaStr.trim()) {
        ...
        if (!Number.isFinite(g)) {
          saveError = 'Profile GPA must be a valid number.';
          return;
        }
        studentProfileGpa = g;
      } else {
        studentProfileGpa = gpaFromMostRecentEducation(studentEducation);
      }
    }
      ...
      <form class="profile-form" onsubmit={handleSubmit}>
        ...
        {#if panelRole !== 'admin'}
          ...
          {#if panelRole === 'student'}
              ...
              {#each educationEntries as entry, eduIndex}
                <div class="education-card">
                  ...
                  <div class="education-grid">
                    ...
                    <div class="education-field education-field-full">
                      <label for={`panel-edu-gpa-${eduIndex}`}>GPA <span class="hint">(optional)</span></label>
                      <input
            ...
            <div class="field">
              <label for="panel-profileGpa">Profile GPA <span class="hint">(optional)</span></label>
              <input
                id="panel-profileGpa"
                type="text"
                inputmode="decimal"
