<script lang="ts">
  ...
  async function handleSubmit(event: SubmitEvent) {
    ...
    let studentProfileGpa: number | null | undefined;
    let studentEducation: ProfileEducationEntry[] | undefined;
    if (isStudentRole) {
      if (profileGpaStr.trim()) {
        ...
        studentProfileGpa = null;
      }
      studentEducation = normalizeEducationForSubmit(educationEntries);
    }
    ...
    try {
      ...
      const payload = {
        ...
        ...(isStudentRole
          ? {
              profileGpa: studentProfileGpa,
              profileEducation: studentEducation,
