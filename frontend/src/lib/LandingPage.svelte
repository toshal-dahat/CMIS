<script lang="ts">
  ...
  import { startSignInByEmail, confirmEmailOtp, signOutUser } from './auth';
  ...
  $effect(() => {
    ...
    const handler = (e: MouseEvent) => closeProfileDropdown(e);
  ...
  <div class="header-inner">
    ...
    {#if $authUser}
      <div class="profile-dropdown-container">
        <button type="button" class="btn-profile-icon" onclick={toggleProfileDropdown} aria-label="Profile options" aria-expanded={showProfileDropdown} aria-haspopup="true">
        ...
        {#if showProfileDropdown}
          <div class="profile-dropdown" role="menu">
            <button type="button" class="profile-dropdown-item" role="menuitem" onclick={viewProfile}>
              View Profile
            </button>
            <button type="button" class="profile-dropdown-item profile-dropdown-item-signout" role="menuitem" onclick={handleSignOut}>
              Sign Out
            </button>
          </div>
        {/if}
...
<main class="main">
  ...
  <section class="cta">
    ...
    {#if $authUser}
      <button type="button" class="btn-cta" onclick={viewProfile}>
        View Profile
      </button>
    {:else}
