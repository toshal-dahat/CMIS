    ...
    mentorshipMentorPauseUntil:
      typeof data.mentorshipMentorPauseUntil === 'string'
        ...
        : data.mentorshipMentorPauseUntil === null
          ? null
          : undefined,
    smsOptIn: typeof data.smsOptIn === 'boolean' ? data.smsOptIn : undefined,
    phoneE164:
...
export async function updateProfile(body: UpdateProfileBody): Promise<ApiResult> {
  try {
    ...
    if (body.smsOptIn !== undefined) payload.smsOptIn = body.smsOptIn;
    if (body.phoneE164 !== undefined) payload.phoneE164 = body.phoneE164;
