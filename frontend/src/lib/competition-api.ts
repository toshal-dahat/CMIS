...
/** Per-team aggregated score summary (leaderboard / results view). */
export interface TeamScoreSummary {
    /** The team being summarised. */
    teamId: string;
    teamName: string;
    /** Number of judges who submitted a score for this team. */
    judgeCount: number;
    /**
     * Average rating per rubric criterion key.
     * e.g. { presentation: 8.5, analysis: 7.0 }
     */
    averageRatings: Record<string, number>;
    /**
     * Overall score: sum of (averageRating × criterion.weight ?? 1)
     * divided by the total weight, giving a 0–10 normalised total.
     */
    scoreTotal: number;
    /** ISO timestamp of the most-recent grading event across all judges. */
