    ...
    if (isStudentRole) {
      ...
      if (profileGpaStr.trim()) {
        ...
        if (!Number.isFinite(g)) {
          submitError = 'Profile GPA must be a valid number.';
          return;
        }
        studentProfileGpa = g;
      } else {
  ...
  <form class="profile-form" novalidate onsubmit={handleSubmit}>
    ...
    {#if signupRole !== 'admin'}
      ...
      {#if signupRole === 'student'}
          ...
          {#each educationEntries as entry, eduIndex}
            <div class="education-card">
              ...
              <div class="education-grid">
                ...
                <div class="education-field education-field-full">
                  <label for={`edu-gpa-${eduIndex}`}>GPA <span class="hint">(optional)</span></label>
                  <input
                    id={`edu-gpa-${eduIndex}`}
                    type="number"
                    min="0"
        ...
        <div class="field">
          <label for="profileGpa">Profile GPA <span class="hint">(optional)</span></label>
          <input
            id="profileGpa"
            type="text"
            inputmode="decimal"
