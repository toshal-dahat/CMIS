<script lang="ts">
  ...
  let mentorshipInterest: '' | 'yes' | 'no' = '';
  let mentorshipKind: '' | 'mentee' | 'mentor' = '';
  let mentorCapacityNum = 5;
  ...
  function hydrateFromProfile() {
    ...
    if (p.profileGpa != null && p.profileGpa !== '') profileGpaStr = String(p.profileGpa);
    else profileGpaStr = '';
  ...
  function hasExistingProfileData(): boolean {
    ...
    return !!(
      ...
      (p.profileGpa != null && p.profileGpa !== '') ||
