<script lang="ts">
  ...
  /** Required on submit: user must choose interested or not; if interested, mentee/mentor + rules apply. */
  ...
  /** Mentee career goals — improves mentor matching. */
    ...
    try {
      ...
      if (!isAdminRole) {
        if (mentorshipInterest === '') {
          submitError = 'Please indicate whether you are interested in the mentorship program.';
          return;
        }
        if (mentorshipInterest === 'yes') {
          if (mentorshipKind !== 'mentee' && mentorshipKind !== 'mentor') {
            submitError = 'Please select mentee or mentor for the mentorship program.';
            return;
          }
          if (mentorshipKind === 'mentor') {
  ...
  <form class="profile-form" novalidate onsubmit={handleSubmit}>
    ...
    {#if signupRole !== 'admin'}
      ...
      <fieldset class="mentorship-fieldset">
        ...
        <p class="field-hint">
          You can change this anytime from your profile. If you opt in, we will ask whether you want to join as a
          mentee or mentor.
        </p>
        <div class="mentorship-radios">
          <label class="mentorship-radio-label">
            <input type="radio" name="mentorship-interest" value="no" bind:group={mentorshipInterest} />
            Not interested
          </label>
          <label class="mentorship-radio-label">
            <input type="radio" name="mentorship-interest" value="yes" bind:group={mentorshipInterest} />
        ...
        {#if mentorshipInterest === 'yes'}
          <div class="mentorship-followup">
            ...
            <div class="mentorship-radios">
              <label class="mentorship-radio-label">
                <input type="radio" name="mentorship-kind" value="mentee" bind:group={mentorshipKind} />
                Mentee
              </label>
              <label class="mentorship-radio-label">
                <input type="radio" name="mentorship-kind" value="mentor" bind:group={mentorshipKind} />
                Mentor
              </label>
            </div>
            {#if mentorshipKind === 'mentee'}
              <div class="field" style="margin-top: 0.75rem;">
                <label for="mentorship-goals"
                ...
                ></textarea>
                <p class="field-hint">
                  Matching uses goals plus your skills and education. A PDF resume is optional—this field matters most when
                  you skip the upload.
                </p>
              </div>
              <div class="field" style="margin-top: 0.75rem;">
                <label for="student-goals"
...
{#if showMentorModal}
  <div class="mentor-modal-backdrop" role="dialog" aria-modal="true" aria-labelledby="mentor-modal-title">
    <div class="mentor-modal">
      <h3 id="mentor-modal-title">Mentor details</h3>
