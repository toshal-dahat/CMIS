...
output "pptx_extractor_lambda_function_name" {
  description = "Dedicated Python Lambda that extracts PPTX text/images"
  value       = var.enable_pptx_extractor_lambda ? aws_lambda_function.pptx_extractor[0].function_name : null
}
