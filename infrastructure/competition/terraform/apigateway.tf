...
# Matches POST /api/judge/competitions/:competitionId/teams/:teamId/summary in index.js.
# Returns { summary, cached, updatedAt }.
# First call runs Textract → Bedrock pipeline; subsequent calls return cached result.
# 60s rate limit is enforced in the application layer (index.js / summaryService.js).
