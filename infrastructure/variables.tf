...
variable "ses_verified_sender" {
  description = "Verified SES sender email used by events-core notifications"
  type        = string
  default     = ""
}

variable "reminder_notification_mode" {
  description = "Reminder delivery channel for events reminders: email (default) or sms"
  type        = string
  default     = "email"
  validation {
