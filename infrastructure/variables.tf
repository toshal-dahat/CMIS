...
variable "twilio_account_sid" {
  description = "Twilio Account SID for student-core SMS reminders"
  type        = string
  default     = ""
}

variable "twilio_auth_token" {
  description = "Twilio Auth Token for student-core SMS reminders"
  type        = string
  default     = ""
  sensitive   = true
}
...
variable "twilio_from_number" {
  description = "Twilio sender phone number (E.164 format) for student-core SMS reminders"
  type        = string
  default     = ""
}
