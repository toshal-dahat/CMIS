...
output "master_skills_table_name" {
  description = "DynamoDB MasterSkills table name"
  value       = aws_dynamodb_table.master_skills.name
}
...
output "sms_send_scheduled_reminder_lambda_name" {
  description = "Lambda name invoked by EventBridge Scheduler for event SMS reminders"
  value       = aws_lambda_function.sms_send_scheduled_reminder.function_name
}

output "sms_send_scheduled_reminder_lambda_arn" {
  description = "Lambda ARN invoked by EventBridge Scheduler for event SMS reminders"
  value       = aws_lambda_function.sms_send_scheduled_reminder.arn
}
