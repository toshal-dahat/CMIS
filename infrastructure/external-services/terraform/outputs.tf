...
output "mentorship_matches_table_name" {
  description = "DynamoDB table name for mentorship match records"
  value       = aws_dynamodb_table.mentorship_matches.name
}

output "mentorship_profile_embeddings_table_name" {
  description = "DynamoDB table name for per-user mentor/mentee profile embedding vectors"
  value       = aws_dynamodb_table.mentorship_profile_embeddings.name
}

output "mentorship_matching_runs_table_name" {
  description = "DynamoDB table name for admin mentorship matching run audit records"
  value       = aws_dynamodb_table.mentorship_matching_runs.name
}
