...
removed {
  from = module.external_core.aws_cloudwatch_event_rule.mentorship_annual_batch[0]
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.external_core.aws_cloudwatch_event_target.mentorship_annual_batch[0]
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.external_core.aws_lambda_permission.mentorship_annual_eventbridge[0]
  lifecycle {
    destroy = false
  }
}
