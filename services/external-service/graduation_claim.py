...
# Overview:
# This file handles the "claim" step after a user clicks the magic link.
# It verifies token validity, creates/reuses account, links UIN, and marks
# token as claimed so the link cannot be reused.
...
# Students: authoritative grad roster (UIN, TAMU/personal emails). Tokens: hashed magic-link rows with TTL + claimed flag.
