...
# Overview:
# This file is the data-access layer for external users.
# Each function performs one DynamoDB read/write so the rest of the app
# does not repeat key names and index names everywhere.
...
# PK: user_id (Cognito sub). GSIs: email-index (login lookups), linked-uin-index (handover uniqueness).
