...
Macro note for future maintainers: this module owns mentorship business logic
(ranking, persistence, batch jobs, caps). System context and diagrams live in
HANDOFF_FOR_NEXT_TEAM.md and EXTERNAL_SERVICE_NOTES.md in this directory.
"""
