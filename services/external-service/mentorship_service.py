...
def build_mentee_suggested_mentors(
    ...
    mentee_vec = mentorship_embeddings.embed_texts_in_chunks(provider, [mentee_text])[0]
    mentor_vecs = mentorship_embeddings.embed_texts_in_chunks(provider, mentor_texts)
