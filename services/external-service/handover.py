...
# Overview:
# "Handover" = move a graduating student from student identity flow
# to alumni/external identity flow while keeping their UIN linkage.
...
def link_uin_to_user(
    ...
    """
    existing = db.get_user_by_id(user_id) or {}
