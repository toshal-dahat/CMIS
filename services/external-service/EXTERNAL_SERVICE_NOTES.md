...
- Legacy background module retained from earlier claim-link workflow.
- Not part of the current documented popup + direct handover UX.

### `graduation_claim.py`

- Legacy claim-processing module retained from earlier workflow.
- Not part of the current documented popup + direct handover UX.
...
| Change graduation popup prompt decision behavior | `handler.py` (`do_graduation_status`) + frontend usage in `frontend/src/lib/LandingPage.svelte` |
