...
This is the core handover document for the Student Identity and Profile system (Point 1), consolidating critical details previously spread across `API.md` and `RESUME_UPLOAD.md`.
