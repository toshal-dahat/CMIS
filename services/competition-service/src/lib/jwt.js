 ...
 *
 * On success, attaches req.judgeAssignment (including teamIds[]).
 * Must be chained after requireAuth.
 *
 * @param {Object} judgeAssignmentService — the DynamoDB service with getAssignment()
 */
function requireJudge(judgeAssignmentService) {
