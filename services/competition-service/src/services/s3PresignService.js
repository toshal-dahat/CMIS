...
/**
 * Presigned PUT URL for uploading a submission (PDF or PPT/PPTX).
 * @param {string} key - S3 object key
 * @param {number} expiresInSeconds - URL TTL
 * @param {string} contentType - MIME type; defaults to application/pdf
 */
async function getPresignedPutUrl(key, expiresInSeconds = 120, contentType = "application/pdf") {
